    ...
    <div className="flex-1 overflow-y-auto bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link to="/" className="text-sm text-gray-600 hover:text-gray-900 flex items-center gap-1 transition-colors">
            <span>←</span>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 space-y-6">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <div className="space-y-6 pl-8">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${
                      theme === 'light' ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${
                      theme === 'dark' ? 'bg-blue-100 text-blue-600' : 'text-gray-400 hover:text-gray-600'
                    }`}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <label htmlFor="font-display" className="block text-sm font-medium text-gray-700 mb-2">
                  Font Display
                </label>
          ...
          <div className="border-b border-gray-200 pb-6">
            <button className="w-full flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Model Defaults</h2>
              </div>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/settings/privacy" className="text-sm text-blue-600 hover:text-blue-700 hover:underline transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link to="/settings/terms" className="text-sm text-blue-600 hover:text-blue-700 hover:underline transition-colors">
                    Terms of Service
                  </Link>
                </li>
              </ul>
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Help & Feedback</h3>
              </div>
